package com.ClarityPlusPackage.OrderMService.ServiceTest;

import com.ClarityPlusPackage.OrderMService.Entity.Order;
import com.ClarityPlusPackage.OrderMService.Implementation.OrderImplementation;
...
//        // Invalid login
//        String emailID2 = "invalid@gmail.com";
//        String password2 = "invalid123";
//
//        when(orderRepo.findByEmailID(emailID2)).thenReturn(null); // Assuming findByEmailID returns null for invalid email
//        when(orderRepo.findPasswordByEmailID(emailID2)).thenReturn(null); // Assuming findPasswordByEmailID returns null for invalid email
//
//        String result2 = orderImplementation.loginGuard(emailID2, password2);
//
//        verify(orderRepo, times(1)).findByEmailID(emailID2);
//        verify(orderRepo, times(1)).findPasswordByEmailID(emailID2);
//        assertEquals("Invalid Login", result);
