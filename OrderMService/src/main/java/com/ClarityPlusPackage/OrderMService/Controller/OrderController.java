...
public class OrderController {
    ...
    public List<String> getOrderByInstituteID(@PathVariable("InstituteID") String InstituteID){
        ...
        List<String> recipientDetailsList = this.restTemplate.getForObject("http://localhost:9007/recipient/search/"+InstituteID+"/", List.class);
    ...
    public String getEmailOfInstituteID(@PathVariable ("InstituteID") String InstituteID){
        //System.out.println("Inside Controller of getEmailOfInstituteID");
        String emailID = this.restTemplate.getForObject("http://localhost:9007/recipient/getEmailID/"+InstituteID+"/",String.class);
    ...
    public List<String> getLogsByInstituteID(@PathVariable("InstituteID") String InstituteID) {
        //System.out.println("Inside Controller");
        List<String> logs = this.restTemplate.getForObject("http://localhost:9007/recipient/search/logs/" + InstituteID + "/", List.class);
    ...
    public ResponseEntity<String> verifyOtp(@PathVariable("InstituteID") String InstituteID, @PathVariable("otp") int otp){
        String otpVerifyResponse = this.restTemplate.postForObject("http://localhost:9007/recipient/checkotp/{InstituteID}/{otp}",null,String.class,InstituteID,otp);
